# Generated by Django 2.2.6 on 2019-10-20 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minimum', models.DecimalField(decimal_places=2, default=500, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=9)),
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('minimum', models.DecimalField(decimal_places=2, default=10000, max_digits=9)),
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.Profile')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=9)),
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('minimum', models.DecimalField(decimal_places=2, default=1000, max_digits=9)),
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.Profile')),
            ],
        ),
        migrations.CreateModel(
